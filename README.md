...
1. Two usages
   1. D4C instance
   2. Method decorator (also for static methods) on your classes
2. This library implements a FIFO queue for O(1) speed. Using built-in JavaScript array will have O(n) issue.
